        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            ...
            transform transition-transform duration-300 hover:scale-105">
              {/* Prefer serving large images from public/ or as <picture> with webp in future */}
              <img src={project.image} alt={project.name} loading="lazy" decoding="async" className="rounded-lg mb-4 
